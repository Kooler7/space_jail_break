...
func check_player_position(new_position) -> void:
	match new_position:
		PlayerPositions.SCREEN_1:
			Globals.get_player().position = positions_coordinates[PlayerPositions.SCREEN_1]
			current_player_position = PlayerPositions.SCREEN_1
		PlayerPositions.SCREEN_2:
			Globals.get_player().position = positions_coordinates[PlayerPositions.SCREEN_2]
			current_player_position = PlayerPositions.SCREEN_2
		PlayerPositions.SCREEN_3:
			Globals.get_player().position = positions_coordinates[PlayerPositions.SCREEN_3]
